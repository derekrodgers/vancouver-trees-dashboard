...
Usual preprocessing steps to clean things up. We will also add a pre-computed bool column for the trees in VanDusen and Stanley Park, because there are so many.
...
Let's save it as a binary so it's fast to read. We don't want to compress, because this dataset isn't very big and it'll slow down read operations.
